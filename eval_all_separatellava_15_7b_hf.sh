...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix scienceqa_img_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix gqa_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix mmbench_en_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix mmbench_cn_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix pope_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix mme_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix seedbench_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
...
python3 -m accelerate.commands.launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix vizwiz_vqa_llava_15_7b_hf \
    --output_path ./logs/ \
    --verbosity=DEBUG \
    --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
