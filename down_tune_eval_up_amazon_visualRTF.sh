...
export RUN_NAME="llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot"
export OUTPUT_DIR="/blob/weiwei/llava_checkpoint/llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot"
...
python3 -m accelerate.commands.launch --num_processes 4 -m lmms_eval --model llava --model_args pretrained=/blob/weiwei/llava_checkpoint/llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot --tasks mmbench_cn --batch_size 1 --log_samples --log_samples_suffix mmbench_cn-ViRFT_CLS_flower_4_shot --output_path ./logs/ --verbosity=DEBUG --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False
python3 -m accelerate.commands.launch --num_processes 4 -m lmms_eval --model llava --model_args pretrained=/blob/weiwei/llava_checkpoint/llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot --tasks pope --batch_size 1 --log_samples --log_samples_suffix pope-ViRFT_CLS_flower_4_shot --output_path ./logs/ --verbosity=DEBUG --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
python3 -m accelerate.commands.launch --num_processes 4 -m lmms_eval --model llava --model_args pretrained=/blob/weiwei/llava_checkpoint/llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot --tasks mme --batch_size 1 --log_samples --log_samples_suffix mme-ViRFT_CLS_flower_4_shot --output_path ./logs/ --verbosity=DEBUG --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
python3 -m accelerate.commands.launch --num_processes 4 -m lmms_eval --model llava --model_args pretrained=/blob/weiwei/llava_checkpoint/llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot --tasks seedbench --batch_size 1 --log_samples --log_samples_suffix seedbench-ViRFT_CLS_flower_4_shot --output_path ./logs/ --verbosity=DEBUG --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
python3 -m accelerate.commands.launch --num_processes 4 -m lmms_eval --model llava --model_args pretrained=/blob/weiwei/llava_checkpoint/llava-onevision-google-siglip-so400m-patch14-384-lmms-lab-llava-onevision-qwen2-7b-si-ewcno-lambda0-ViRFT_CLS_flower_4_shot --tasks vizwiz_vqa --batch_size 1 --log_samples --log_samples_suffix vizwiz_vqa-ViRFT_CLS_flower_4_shot --output_path ./logs/ --verbosity=DEBUG --hf_hub_log_args hub_repo_name=lm-eval-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False 
